...
\begin{block}{}
These show the marginal distributions of the 9-dimensional distribution. In practice, we also want forecast for smaller geographical areas as well.
\end{block}
\end{textblock}}
...
## Produce probabilisic forecasts
\fontsize{9.5}{11}\sf
